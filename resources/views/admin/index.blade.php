                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">Tanggal Buka: {{ $lastPeriode->tgl_buka }} Tanggal Tutup: {{ $lastPeriode->tgl_tutup }} </div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$jumlahKoor}} </div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-7">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Jenjang Penerima BESTARI</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <div class="chart-bar">
            ...
            <div class="col-xl-6 col-lg-5">
                <div class="card shadow mb-4">
                    <!-- Card Header - Dropdown -->
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Presentase Penerima BESTARI</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
